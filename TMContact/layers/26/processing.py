...
class Contact():
    ...
    def read_csv(self):
        ...
        self.save_file(trainID, '/lustre/home/qfchen/ContactMap/TMContact/dataset/valID.txt')
        # 20%  Test Data
        testID = dataID[int(0.8 * nums):]
        self.save_file(trainID, '/lustre/home/qfchen/ContactMap/TMContact/dataset/testID.txt')
    ...
    def get_feature_label(self, ID, flag):
        ...
        feature = []
        label = []
        label_dir = "/lustre/home/qfchen/ContactMap/TMContact/lable/"
        # get lable path
        for item in ID:
