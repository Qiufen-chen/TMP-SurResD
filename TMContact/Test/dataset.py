...
class mydataset(Data.Dataset):
    ...
    def __getitem__(self, index):
        if len(self.images) ==2:
            ...
            # if 'onehot_pair' in self.images[0][index] and 'ccmpred' in self.images[1][index]:
            #     onehot_path = self.images[0][index]
            #     ccmpred_path = self.images[1][index]
            #     lable_path = self.targets[index]
            #     onehot = feature_concat.get_onehot_pair(onehot_path)
            #     ccmpred = feature_concat.get_ccmpred(ccmpred_path)
            #     label = feature_concat.get_lable(lable_path)
            #     feature = torch.cat([onehot, ccmpred], dim=0)
            #     print(feature.shape)
            ...
            # if 'onehot_pair' in self.images[0][index] and 'profold' in self.images[1][index]:
            #     onehot_path = self.images[0][index]
            #     profold_path = self.images[1][index]
            #     lable_path = self.targets[index]
            #     onehot = feature_concat.get_onehot_pair(onehot_path)
            ...
            if 'onehot' in self.images[0][index] and 'hmm' in self.images[1][index] and 'ccmpred' in self.images[2][index]:
            ...
            if 'onehot_pair' in self.images[0][index] and 'ccmpred' in self.images[1][index] and 'profold' in self.images[2][
                index]:
                onehot_path = self.images[0][index]
                ccmpred_path = self.images[1][index]
                profold_path = self.images[2][index]
                ...
                feature = torch.cat([torch.cat([onehot, ccmpred], dim=0), profold], dim=0)
                return feature, label

            if 'hmm' in self.images[0][index] and 'ccmpred' in self.images[1][index] and 'profold' in self.images[2][
                index]:
                hmm_path = self.images[0][index]
                ccmpred_path = self.images[1][index]
                profold_path = self.images[2][index]
            ...
            if 'onehot' in self.images[0][index] and 'ccmpred' in self.images[1][index] and 'profold' in self.images[2][
                index]:
                onehot_path = self.images[0][index]
                ccmpred_path = self.images[1][index]
                profold_path = self.images[2][index]
