...
x_train, y_train, x_val, y_val, x_test, y_test = con.main('onehot_pair')
...
def main():
    ...
    optimizer = th.optim.Adamax(model.parameters(), lr=0.001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0)
    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0:
            th.save(model.state_dict(), "/lustre/home/qfchen/ContactMap/TMContact/model/" + "18_mask_Normalization_onehot_pair_16_" + str(epoch))
