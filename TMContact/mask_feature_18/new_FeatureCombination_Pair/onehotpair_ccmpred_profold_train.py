...
x_train, y_train, x_val, y_val, x_test, y_test = con.main('onehotpair+ccmpred+profold')
...
def main(n):
    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0:
            th.save(model.state_dict(), "/lustre/home/qfchen/ContactMap/TMContact/model/" + "18_mask_onehotpair_ccmpred_profold_" + str(epoch))
