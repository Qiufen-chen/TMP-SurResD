...
import torch
import torch as th
# from torchTMmmary import TMmmary
...
x_train, y_train, x_val, y_val, x_test, y_test = con.main('onehotpair+profold')
...
def main(n):
    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0:
            th.save(model.state_dict(), "/lustre/home/qfchen/ContactMap/TMContact/model/" + "18_mask_onehotpair_profold_" + str(epoch))
