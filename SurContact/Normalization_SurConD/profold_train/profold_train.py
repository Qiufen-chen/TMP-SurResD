...
class mydataset(Data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print(feature_connection.shape)
...
x_train, y_train, x_val, y_val, x_test, y_test = con.main('profold')
...
def main():
    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0:
            th.save(model.state_dict(), "/lustre/home/qfchen/ContactMap/SurContact/model/" + "profold_" + str(epoch))
