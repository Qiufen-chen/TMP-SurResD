...
class Contact():
    ...
    def get_feature_label(self, ID, flag):
        ...
        if flag == 'onehot':
            feature_dir = "/lustre/home/qfchen/ContactMap/SurContact/onehot/"

        elif flag == 'onehot_pair':
            feature_dir = "/lustre/home/qfchen/ContactMap/SurContact/onehot_pair/"

        elif flag == 'hmm':
            feature_dir = "/lustre/home/qfchen/ContactMap/SurContact/hhblits/"

        elif flag == 'ccmpred':
            feature_dir ="/lustre/home/qfchen/ContactMap/SurContact/ccmpred/"

        elif flag == 'profold':
            feature_dir = "/lustre/home/qfchen/ContactMap/SurContact/profold/"

        label_dir = "/lustre/home/qfchen/ContactMap/SurContact/lable/"

        # Train Data saved in feature and label, actually the path
        feature = []
        label = []
        for item in ID:
